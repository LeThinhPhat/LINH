...
export default function AdminSidebar({
  ...
  const nav = useMemo(
    () => [
      ...
      { to: "/admin/withdrawals", label: "Quản Lý Rút Điểm", key: "withdrawals", icon: Wallet },
      { to: "/admin/orders", label: "Quản Lý Đơn Hàng", key: "orders", icon: ShoppingBag },
      { to: "/admin/transactions", label: "Quản Lý Giao Dịch", key: "transactions", icon: ArrowLeftRight },
    ],
    [],
  );
